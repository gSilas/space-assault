...
{
    class HighscoreMenuScreenOffline : MenuScreen
    {
        MenuEntry back;
        bool _enter;
        ...
        private HighScoreListFile _highScoreListOff;
        ...
        // Constructor.
        public HighscoreMenuScreenOffline(bool enter) : base("Highscore")
        {
            ...
            _highScoreListOff = new HighScoreListFile();
        }
                        ...
                        switch (curKey)
                        {
                            ...
                            case Keys.Enter:
                                if (EntryText.Length > 2)
                                {
                                    ...
                                    _highScoreListOff.Add(EntryText, Global.HighScorePoints);
                                    EntryText = "";
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (this.TransitionPosition <= 0f)
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    Global.UIBatch.DrawString(Global.Font, _highScoreListOff._scoresList[i].Name, new Vector2(spawnPointX + spaltenAbstand, spawnPointY + i * zeilenAbstand), Color.White);
                    Global.UIBatch.DrawString(Global.Font, (_highScoreListOff._scoresList[i].Points).ToString(), new Vector2(spawnPointX + spaltenAbstand * 2, spawnPointY + i * zeilenAbstand), Color.White);
                }
                Global.UIBatch.End();
