...
using IrrKlang;
using SpaceAssault.Utils.Demo;

namespace SpaceAssault.Screens.Demo
{
    class DemoGameplayScreen : GameScreen
    {
        //#################################
        // Variables
        //#################################
        ...
        float _sphereAlpha;
        List <string> _effectList = new List<string>();
        int _effect = 0;
        ...
        private DemoWaveBuilder _waveBuilder;
        private DemoBoidBuilder _boidBuilder;
        private Planet _planet;
        private InputState _input;
        private bool _boidsActivate = false;
        ...
        private Model _asteroid1;
        private Model _asteroid2;
        private Model _asteroid3;
        private List <Asteroid> _astList = new List<Asteroid>();
                ...
                switch (Global.DemoMode)
                {
                    case ("Models"):
                        if (_boidsActivate)
                        {
                            ...
                            _boidBuilder.Update(gameTime, ref _asteroidField, ref _droneFleet);
                        }
                        break;
                    case ("Effects"):
                        _station.Update(gameTime);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            switch (Global.DemoMode)
            {
                ...
                case ("Effects"):
                    _station.Draw(Global.StationColor);
                    _dialog.Draw(_effectList[_effect] + "\nPress 'E' to show effect.\nPress 'C' to change the particles.");
                    break;
                case ("Gameplay"):
